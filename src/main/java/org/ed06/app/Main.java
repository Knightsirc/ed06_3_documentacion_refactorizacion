...
public class Main {
    ...
    private static String mailCliente() {
        String email;
        while (true) {
            try {
    ...
    private static void esVip(Hotel hotel, String nombre, String email, String dni) {
        System.out.println("¿Es VIP? (true/false): ");
        boolean esVip = scanner.nextBoolean();
        hotel.registrarCliente(nombre, email, dni, esVip);
    }

    private static void precargaDatos(Hotel hotel) {
